...
struct SLightFieldSurfaceMetaData
{
	...
	int OctHighResolution;
	int OctLowResolution;
...
struct SLightFieldCubemap
{
	...
	{
		RadianceCubemap = Texture::createEmpty("RadianceCubemap", vResolution, vResolution, vImageFormat, Texture::DIM_CUBE_MAP, true);
		DistanceCubemap = Texture::createEmpty("DistanceCubemap", vResolution, vResolution, vImageFormat, Texture::DIM_CUBE_MAP, true);
		NormalCubemap = Texture::createEmpty("NormalCubemap", vResolution, vResolution, vImageFormat, Texture::DIM_CUBE_MAP, true);
	}
